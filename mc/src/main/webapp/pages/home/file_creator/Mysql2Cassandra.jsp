...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>维度定时刷新(用于join)/mysql->cassandra</title>
		<!-- header js css -->
				...
				<div id="content">
					...
					<div id="breadcrumb_div" name="breadcrumb_div">
						<ul class="breadcrumb">
							...
							<li>mysql->cassandra<span class="divider">/</span></li>
							<li>${defFileTask.fileId}</li>
						</ul>
					</div>
					
					<form name="defFileTaskDataForm" class="form-horizontal" method="post" id="defFileTaskDataForm" action="${ctx}/task/writeImportMysqlToCassandraTask.do" onsubmit=""> 
						<input id="fileType" name="fileType" type="hidden" value="Mysql2Cassandra" />
